  ...
  const runGraphBuild = async () => {
    ...
    const graphModeLabel = useProjectNameGraphId
      ...
      : effectiveGraphId
        ...
        : "new graph";
    addSystemLog(
      `Starting graph build for ${projectId} (${graphModeLabel}, backend: ${resolvedGraphBackendForRequest || "auto"}, graph name: ${resolvedGraphName}, chunk_mode: ${resolvedChunkMode}, chunk_size: ${resolvedChunkSize}, chunk_overlap: ${resolvedChunkOverlap})...`,
    );
