...
**个人类（具体）**：
{{ENTITES_EXAMPLES_IN_SYSTEM_PROMPT}}

**个人类（兜底）**：
{{ENTITES_EXCEPTIONS_IN_SYSTEM_PROMPT}} (不属于上述具体类型时使用）

**组织类（具体）**：
{{ORGANIZATIONS_EXAMPLES_IN_SYSTEM_PROMPT}}

**组织类（兜底）**：
{{ORGANIZATIONS_EXCEPTIONS_IN_SYSTEM_PROMPT}}（不属于上述具体类型时使用）
